...
```mermaid
flowchart LR
    Scan["More farm scans"] --> Data["Permissioned, quality-checked data"]
    Data --> Model["Better citrus AI"]
    Model --> Report["Better farm reports"]
    Report --> Trust["Trust and repeat customers"]
    Trust --> Scan
```
